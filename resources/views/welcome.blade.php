                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Simple e Intuitivo, El sistema esta deseñado para que su manejo sea facil e instuitivo. con un diseño moderno y profesional.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Los modulos del sistema son los componentes del principales de software, que sirven para establecer flujo de trabajo.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">EL Sistema, esta desarrollado con las mejores herramientas y practica en seguridad informatica. por ejemplo (SSL) </p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <h2>Responsive o Multipantalla</h2>
                    <p class="mb-4">El Sistema esta diseñado para ser ejecutado en multiples tamaños de pantalla, creando interfaces adaptativas y practicas.</p>
    ...
    <div class="section light-bg">
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#communication">Seguimiento de Proyectos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#schedule">Ventas de Hormigon</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#messages">Seguridad</a>
                </li>
                <!-- <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <h2>Multiples Sistemas Operativos</h2>
                        <p class="mb-4">El sisema esta desarrollodo con tecnologia web, esto significa que el software funciona en cualquier Sisteme Operativo.</p>
