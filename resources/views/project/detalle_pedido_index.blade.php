        ...
        <tbody>
            @foreach($dp as $item)
                <tr>
                    ...
                    <td><input type="number" id="precio-{{ $item->id }}" class="form-control" min="0" step="0.1" placeholder="precio" value="{{ $item->precio }}" oninput="detalle_pedido_edit('{{ $item->id }}', 'precio', '{{ route('detalle_pedido.edit', array($item->id, 'precio', 'valor')) }}')"></td>
